...
public class Comment implements Serializable {
    ...
    public Comment modifiedAt(Instant modifiedAt) {
    ...
    public Comment linkedPost(Post post) {
        this.setLinkedPost(post);
        return this;
    }

    public void setLinkedPost(Post post) {
        this.linkedPost = post;
    }

    public MUser getCommentCreator() {
        return this.commentCreator;
    }

    public Comment commentCreator(MUser mUser) {
        this.setCommentCreator(mUser);
        return this;
    }

    public void setCommentCreator(MUser mUser) {
        this.commentCreator = mUser;
    }
