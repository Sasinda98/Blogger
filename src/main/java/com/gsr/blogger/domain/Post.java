...
public class Post implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "posts", "channelCreator" }, allowSetters = true)
    ...
    public Post addChannels(Channel channel) {
        this.channels.add(channel);
        channel.getPosts().add(this);
        return this;
    }

    public Post removeChannels(Channel channel) {
    ...
    public void setChannels(Set<Channel> channels) {
        if (this.channels != null) {
            this.channels.forEach(i -> i.removePosts(this));
        }
        if (channels != null) {
            channels.forEach(i -> i.addPosts(this));
        }
