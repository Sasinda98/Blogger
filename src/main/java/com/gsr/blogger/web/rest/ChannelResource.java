...
/**
 * REST controller for managing {@link com.gsr.blogger.domain.Channel}.
 */
@RestController
@RequestMapping("/api")
public class ChannelResource {
    ...
    public ResponseEntity<ChannelDTO> partialUpdateChannel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, channelDTO.getId().toString())
        );
    }
