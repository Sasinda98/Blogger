  ...
  describe('Channel Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should update editForm', () => {
        const channel: IChannel = { id: 456 };
        const posts: IPost = { id: 87495 };
        channel.posts = [posts];
        const muser: IMUser = { id: 96202 };
        channel.muser = muser;
        ...
        expect(comp.mUsersSharedCollection).toContain(muser);
      });
    });
