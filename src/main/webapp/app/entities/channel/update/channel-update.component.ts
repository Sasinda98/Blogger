...
export class ChannelUpdateComponent implements OnInit {
  ...
  protected updateForm(channel: IChannel): void {
    ...
    this.mUsersSharedCollection = this.mUserService.addMUserToCollectionIfMissing(this.mUsersSharedCollection, channel.muser);
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.mUserService
      ...
      .pipe(map((mUsers: IMUser[]) => this.mUserService.addMUserToCollectionIfMissing(mUsers, this.editForm.get('muser')!.value)))
  ...
  protected createFromForm(): IChannel {
    return {
      ...
      muser: this.editForm.get(['muser'])!.value,
    };
  }
}
