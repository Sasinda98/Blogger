...
export class ChannelUpdateComponent implements OnInit {
  ...
  protected updateForm(channel: IChannel): void {
    this.editForm.patchValue({
      ...
      relatedPosts: channel.relatedPosts,
      channelCreator: channel.channelCreator,
    });

    this.postsSharedCollection = this.postService.addPostToCollectionIfMissing(this.postsSharedCollection, ...(channel.relatedPosts ?? []));
  ...
  protected loadRelationshipsOptions(): void {
    this.postService
      ...
      .pipe(
        map((posts: IPost[]) => this.postService.addPostToCollectionIfMissing(posts, ...(this.editForm.get('relatedPosts')!.value ?? [])))
      )
  ...
  protected createFromForm(): IChannel {
    return {
      ...
      relatedPosts: this.editForm.get(['relatedPosts'])!.value,
