  ...
  describe('MUser Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call statistic query and add missing value', () => {
        ...
        const statistic: IUserStatistic = { id: 93753 };
        mUser.statistic = statistic;

        const statisticCollection: IUserStatistic[] = [{ id: 86225 }];
        jest.spyOn(userStatisticService, 'query').mockReturnValue(of(new HttpResponse({ body: statisticCollection })));
        const expectedCollection: IUserStatistic[] = [statistic, ...statisticCollection];
        ...
        expect(userStatisticService.addUserStatisticToCollectionIfMissing).toHaveBeenCalledWith(statisticCollection, statistic);
        expect(comp.statisticsCollection).toEqual(expectedCollection);
      });

      it('Should update editForm', () => {
        const mUser: IMUser = { id: 456 };
        const statistic: IUserStatistic = { id: 77405 };
        mUser.statistic = statistic;
