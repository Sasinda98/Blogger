...
class MUserResourceIT {
    ...
    public static MUser createEntity(EntityManager em) {
        MUser mUser = new MUser().username(DEFAULT_USERNAME).email(DEFAULT_EMAIL).dob(DEFAULT_DOB).about(DEFAULT_ABOUT);
        return mUser;
    }
    ...
    public static MUser createUpdatedEntity(EntityManager em) {
        MUser mUser = new MUser().username(UPDATED_USERNAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).about(UPDATED_ABOUT);
        return mUser;
    }
    ...
    void putNewMUser() throws Exception {
        ...
        updatedMUser.username(UPDATED_USERNAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).about(UPDATED_ABOUT);
    ...
    void partialUpdateMUserWithPatch() throws Exception {
        ...
        partialUpdatedMUser.email(UPDATED_EMAIL).dob(UPDATED_DOB);
    ...
    void fullUpdateMUserWithPatch() throws Exception {
        ...
        partialUpdatedMUser.username(UPDATED_USERNAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).about(UPDATED_ABOUT);
