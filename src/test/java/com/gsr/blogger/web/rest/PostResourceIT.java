...
import com.gsr.blogger.domain.Post;
import com.gsr.blogger.repository.PostRepository;
import com.gsr.blogger.service.dto.PostDTO;
import com.gsr.blogger.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getIsDeleted()).isEqualTo(DEFAULT_IS_DELETED);
    }
    ...
    void putNewPost() throws Exception {
        ...
        assertThat(testPost.getIsDeleted()).isEqualTo(UPDATED_IS_DELETED);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.createdAt(UPDATED_CREATED_AT).isDeleted(UPDATED_IS_DELETED);
